...
class EnquiryViewController: UIViewController,UITextFieldDelegate,UITextViewDelegate,UIAlertViewDelegate,MFMailComposeViewControllerDelegate  {
    ...
    override func viewDidLoad() {
        ...
        if self.view.frame.size.height==1024{
            ...
            company_text.frame.origin.y = company_text.frame.origin.y+20
            
            contact_text.frame.size.height = 45
            
            contact_text.frame.origin.y = contact_text.frame.origin.y+30
            
            street_text.frame.size.height = 45
            
            street_text.frame.origin.y = street_text.frame.origin.y+40
            
            city_text.frame.size.height = 45
            
            city_text.frame.origin.y = city_text.frame.origin.y+50
            
            property_textview.frame.origin.y = property_textview.frame.origin.y+60
            
            details_textview.frame.origin.y = details_textview.frame.origin.y+50
    ...
    @IBAction func SubmitDetails(sender: AnyObject) {
        ...
        self.presentViewController(mc, animated: true, completion: nil)
         ...
         property_textview.text = ""
        
         details_textview.text = ""
