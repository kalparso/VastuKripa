...
- (void)_initDefaultProperties {
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        ...
        _rearViewRevealWidth = 390.0f;
        _rearViewRevealOverdraw = 150.0f;
        _rearViewRevealDisplacement = 120.0f;
        _rightViewRevealWidth = 525.0f;
        _rightViewRevealOverdraw = 0.0f;
        _rightViewRevealDisplacement = 120.0f;
        ...
        _rearViewPosition = FrontViewPositionLeft;
        _rightViewPosition = FrontViewPositionLeft;
        _rearViewRevealWidth = 245.0f;
        _rearViewRevealOverdraw = 60.0f;
        _rearViewRevealDisplacement = 40.0f;
        _rightViewRevealWidth = 245.0f;
        _rightViewRevealOverdraw = 0.0f;
