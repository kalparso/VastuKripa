...
//        self.view.addGestureRecognizer(self.revealViewController().panGestureRecognizer())
        ...
        if self.view.frame.size.height<568{
         ...
         scroll_view.contentSize = CGSize(width:self.view.frame.size.width, height:hospital_btn.frame.origin.y+hospital_btn.frame.size.height+55)
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        navigation_title.text =  "Onsite Vastu"
