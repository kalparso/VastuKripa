...
//        var setUserID = NSUserDefaults.standardUserDefaults()
//        
//        
//        setUserID.setValue(" 53eef4b20251d4edc73734def033784b1fa174f966c8ad8abb6a5279a28031bc", forKey: "device_ID")
//       
//        let alert = UIAlertView(title:"", message:"53eef4b20251d4edc73734def033784b1fa174f966c8ad8abb6a5279a28031bc", delegate: nil, cancelButtonTitle:"OK")
//        
//        alert.show()
//        
//       parsedJson()
...
//        sleep(1)
    ...
    func application(
        ...
        didRegisterForRemoteNotificationsWithDeviceToken deviceToken: NSData
           ...
           // 53eef4b20251d4edc73734def033784b1fa174f966c8ad8abb6a5279a28031bc
            
            let alert = UIAlertView(title:"", message:deviceTokenString, delegate: nil, cancelButtonTitle:"OK")
    ...
    func application(
        ...
        didFailToRegisterForRemoteNotificationsWithError error: NSError
            ...
            let aa:String = error.description
            
            let alert = UIAlertView(title:"", message:aa, delegate: nil, cancelButtonTitle:"OK")
...
//    {
//        
//        homeController.load_image(imageURl!, meg: message)
//        
//     }
    
   NSNotificationCenter.defaultCenter().postNotificationName("passData", object:nil, userInfo:data as [NSObject : AnyObject])
    ...
    func parsedJson(){
        ...
        getConn.startConnectionWithString("pushDeviceId", httpMethodType:Post_Type, httpBodyType: passDict) { (recevedData) -> Void in
            ...
            if(self.getConn .responseCode() == 1){
                ...
                let alert = UIAlertView(title:"", message:Device_id, delegate: nil, cancelButtonTitle:"OK")
