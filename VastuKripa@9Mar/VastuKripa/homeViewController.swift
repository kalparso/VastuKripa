...
class homeViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate,NSURLConnectionDelegate, NSXMLParserDelegate,CLLocationManagerDelegate,UIImagePickerControllerDelegate,UIWebViewDelegate,UIGestureRecognizerDelegate {
    ...
    var place_btn_hieght = CGFloat(30)
...
//     blinkTimer = NSTimer.scheduledTimerWithTimeInterval(0.1, target: self, selector: "update", userInfo: nil, repeats: true)
//        
//     NSRunLoop.currentRunLoop().addTimer(blinkTimer, forMode: NSRunLoopCommonModes)
       ...
       circle_ebook.titleLabel!.textAlignment = NSTextAlignment.Center
        ...
        place_lbl.frame.origin.x = (navigation_view.frame.size.width - place_lbl.frame.size.width)/2
      ...
      self.view.addGestureRecognizer(self.revealViewController().tapGestureRecognizer())
        ...
        vastuTipes_View.frame.origin.y = self.view.frame.size.height-vastuTipes_View.frame.size.height-22-65
        
        vastuTipes_View.frame.origin.x = (self.view.frame.size.width-vastuTipes_View.frame.size.width)/2
        ...
        if self.view.frame.width == 375{
            ...
            info_Btn.frame.origin.x = self.view.frame.size.width-info_Btn.frame.size.width-20;
            
            bellBtn.frame.origin.x = info_Btn.frame.origin.x-35
        ...
        if self.view.frame.size.width == 375 && self.view.frame.size.height>568{
            ...
            right_line_view.frame.size.width = right_line_view.frame.size.width+20
            
            left_line_view.frame.size.width = left_line_view.frame.size.width+20
        
            
            right_line_view.frame.origin.x = self.view.frame.size.width -  right_line_view.frame.size.width-2
            
             more_tips_btn.frame.origin.y = vastuTipes_View.frame.origin.y-20
            
        }
        
        if  (self.view.frame.size.width != 768){
            
            checkAlso_lbl.frame.origin.x = (self.view.frame.size.width-checkAlso_lbl.frame.size.width)/2
            
            kitchen_btn.frame =  CGRectMake(1,place_btn_hieght,self.view.frame.size.width/3-8,place_btn_hieght)
            ...
            temple_btn.frame =  CGRectMake(kitchen_btn.frame.width+1,place_btn_hieght,kitchen_btn.frame.size.width,place_btn_hieght)
            ...
            toilet_btn.frame =  CGRectMake(temple_btn.frame.origin.x+temple_btn.frame.size.width+1,place_btn_hieght,kitchen_btn.frame.size.width,place_btn_hieght)
            ...
            arrow.frame.origin.x =  dirCabin_btn.frame.origin.x + dirCabin_btn.frame.size.width+1
            ...
            more_tips_btn.frame.origin.y = vastuTipes_View.frame.origin.y-more_tips_btn.frame.size.height-20
        ...
        more_tips_btn.frame.origin.y = vastuTipes_View.frame.origin.y-more_tips_btn.frame.size.height-10
        ...
        if(self.view.frame.size.height<568){
            ...
            more_tips_btn.frame.origin.y = vastuTipes_View.frame.origin.y-more_tips_btn.frame.size.height
        ...
        if self.view.frame.size.height == 568{
            ...
            compass_img.frame.size.height = 245
            
            compass_img.frame.size.width = 245
        ...
        if self.view.frame.size.height == 1024{
            ...
            vastuTip_btn.frame.size.height = 420
            
            selectPlace_btn.frame.size.height = 420
            
            vastuProduct_btn.frame.size.height = 420
            
            onlineVastu_btn.frame.size.height = 420
            
            advanceVastu_btn.frame.size.height = 420
            
            consultNow_btn.frame.size.height = 420
            
            vastu_ebook_btn.frame.size.height = 420
            
        }else if self.view.frame.size.width == 375{
            
            vastuTip_btn.frame.size.height = 200
            
            selectPlace_btn.frame.size.height = 200
            
            vastuProduct_btn.frame.size.height = 200
            
            onlineVastu_btn.frame.size.height = 200
            
             advanceVastu_btn.frame.size.height = 200
            
            consultNow_btn.frame.size.height = 200
            
            vastu_ebook_btn.frame.size.height = 200

        }else{
            
            
            vastuTip_btn.frame.size.height = 180
            
            selectPlace_btn.frame.size.height = 180
            
            vastuProduct_btn.frame.size.height = 180
            
            onlineVastu_btn.frame.size.height = 180
            
            advanceVastu_btn.frame.size.height = 180
            
            consultNow_btn.frame.size.height = 180
            
            vastu_ebook_btn.frame.size.height = 180
...
// // // vastu_ebook_btn
        ...
        vastu_ebook_btn.frame.size.width = self.view.frame.size.width-10
         ...
         vastu_ebook_btn.frame.origin.y =  vastuTip_btn.frame.origin.y+vastuTip_btn.frame.size.height+5
...
// // // vastuProduct_btn
        ...
        vastuProduct_btn.frame.origin.y = vastu_ebook_btn.frame.origin.y+selectPlace_btn.frame.size.height+5
...
// // // vastuProduct_btn
       ...
       onlineVastu_btn.frame.origin.x = (self.view.frame.size.width-onlineVastu_btn.frame.size.width)/2
        ...
        onlineVastu_btn.frame.origin.y = vastuProduct_btn.frame.origin.y+vastuProduct_btn.frame.size.height+5
...
// // // vastuProduct_btn
        ...
        advanceVastu_btn.frame.origin.y = onlineVastu_btn.frame.origin.y+onlineVastu_btn.frame.size.height+5
...
// // // consultNow_btn
        ...
        consultNow_btn.frame.origin.y = advanceVastu_btn.frame.origin.y+advanceVastu_btn.frame.size.height+5
...
// // // vastuCompass_btn
        ...
        selectPlace_btn.frame.origin.y = consultNow_btn.frame.origin.y+consultNow_btn.frame.size.height+5
        ...
        main_scrollView.contentSize = CGSize(width:self.view.frame.size.width, height: selectPlace_btn.frame.origin.y+selectPlace_btn.frame.size.height+10)
...
////circle_vastutips
        ...
        circle_vastutips.frame.size.height = 160
        
        circle_vastutips.frame.size.width = 160
        ...
        circle_ebook.frame.size.height = 160
        
        circle_ebook.frame.size.width = 160
        ...
        circle_product.frame.size.height = 160
        
        circle_product.frame.size.width = 160
        ...
        circle_online.frame.size.height = 160
        
        circle_online.frame.size.width = 160
        ...
        circle_advance.frame.size.height = 160
        
        circle_advance.frame.size.width = 160
        ...
        circle_consult.frame.size.height = 160
        
        circle_consult.frame.size.width = 160
        ...
        circle_compass.frame.size.height = 160
        
        circle_compass.frame.size.width = 160
   ...
   override func  viewWillDisappear(animated: Bool) {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector:"getRemoteDict:", name:"passData", object:nil);
     ...
     setVastuCount()
      ...
      menuBtn.hidden = false
            ...
            
        {
            ...
            place_lbl.text = "Vastu Calculator"
   ...
   @objc func getRemoteDict(getNoti:NSNotification) {
    ...
    let  meg = info.valueForKey("acme2")?.valueForKey("message") as! NSDictionary
    
    
    imageURl = meg.valueForKey("image") as? String
    
    let message = meg.valueForKey("message") as! String
    ...
    @IBAction func tapMore_tips_btn(sender: AnyObject) {
        ...
        if scroll == 1{
            ...
            info_lineView.frame.size.width = self.info_View.frame.width+1
            
            info_lineView.frame.origin.x = -3
    ...
    @IBAction func tapToilet_btn(sender: AnyObject) {
        ...
        if scroll == 1{
            ...
            array_Tips = ["• North-West zone is the most suited location for constructing the Toilets.\n\n• The outlet of the water should not be in the Agnisthaan(South-East zone) or the Nairuti kona(South-West zone).\n\n• You may construct the Septik Tank in the North-West zone.\n\n• Toilet seat should not installed in the Eshanya Kona(North-East zone) of the bathroom. The toilet seat should be placed in such a manner that the person sitting on it faces Uttar disha(North side). The person sitting on the wc pot should never face or back the rising Sun(Poorav disha - East side).\n\n• Pictures/statues, sacred symbols or murals of God should not be installed on toilet common wall.\n\n• The washbasin, shower and mirror should be installed on the Uttar disha(North side) or the Poorav disha(East side).\n\n• Prefer white, off white or beige shade tiles, wc pot and basin for all toilets.\n\n• The toilet door should be kept closed even when not in use, to avoid negative energies to spread in the property.\n\n• General attributes of North-West zone(Vayu Kona):\nNorth-West Ruled by: Lord Vayu(The God of Winds)\nNorth-West Ruled by: Moon Planet(Chandra/Shashi/Chaand)\nColor: White/Ivory White/Light Yellow.\nMantra to be recited: 'Om Shram Shrim Shrom Sah Chandramasey Namah'.\nGemstone: Pearl(Moti/Mukta)\nElement: Wind(Vayu Tatva).",
                ...
                "• Constructing a Toilet in the West zone is reasonably alright.\n\n• The Constructing a Toilet in the West zone is reasonably alright.\n\n• The washbasin, shower and mirror should be installed on the Uttar disha(North side) or the Poorav disha(East side).\n\n• The outlet of the water should not be in the Agnisthaan(South-East zone) or the Nairuti kona(South-West zone).\n\n• Toilet seat should not installed in the Eshanya Kona(North-East zone) of the bathroom. The toilet seat should be placed in such a manner that the person sitting on it faces Uttar disha(North side). The person sitting on the wc pot should never face or back the rising Sun(Poorav disha - East side).\n\n• Avoid installing orange or red shade wall or flooring tiles.\n\n• Prefer white, off white or beige shade tiles, wc pot and basin for all toilets.\n\n• The toilet door should be kept closed even when not in use, to avoid negative energies to spread in the property.\n\n• Install the mirror and wash basin on the Northern or Eastern wall.\n\n• Install the shower panel on the Northern or Eastern wall.\n\n• General attributes of West zone(Paschim disha):\nWest Ruled by: Lord Varuna(The God of Rain and Water)\nWest Ruled by: Saturn Planet(Shani)\nColor: Black, Blue.\nMantra to be recited: 'Om Pram Prim Proom Sah Shanischarey Namah'.\nGemstone: Blue Sapphire(Neelam/Neelima).",
    ...
    @IBAction func tapDoor_btn(sender: AnyObject) {
        ...
        if scroll == 1{
            ...
            array_Tips = ["• If the Main door is at the North of North-West direction(ie. if the door is facing the North side), then it is considered reasonably good.\n\n• If the Main door is at the West of North-West direction(ie. if the door is facing the West side), then it is considered a flaw(Vastu dosha).\n\n• The Main door should open inwards in a clockwise direction.\n\n• Install a light outside the main door and keep it switched on during the evening hours.\n\n• Install the SACRED SYMBOL of Om or Swastik above the Entrance Door frame(install the symbols inside and outside).\n\n• Above the Main Door, Install a pure Silver Coin depicting Religious Symbols of Om/Swastik/Om-Swastik Trishul/Lord Ganeshaji/Ek-Onkar/Navkar.\n\n• Since the Main Door is not well positioned, Install the POWER GRID STICKabove the Main Door Frame(at the inner side/inside the property).\no Option 1: Screw/fix 2 'white metal hooks' on the wall(above the main door frame)(keep about 1.5 feet distance between the 2 'hooks'). Hang/place the POWER GRID STICK between the 2 'hooks'.\no Option 2: Embed the POWER GRID STICK within the wall(above the main door frame). Create a horizontal hole in the wall(hole should be measuring 25 inches long x 1.5 inches deep). Place the POWER GRID STICK in it. Thereafter re-plaster the wall.\n",
                ...
                "• Main door located at the South-West direction is considered a major flaw(Vastu dosha) and may prove inauspicious. Try to relocate the Main Door towards East/North/North-East side.\n\n• Above the Main Door frame, Install a picture of Lord Hanumanji(inorder to gain Divine protection from the negativities).\n\n• Install the SACRED SYMBOL of Om or Swastik above the Entrance Door frame(install the symbols inside and outside). Avoid sleeping on the metal/wrought iron bed.\n\n• Install the Temple at this zone and install our DIVINE CONNECT YANTRA FRAMEin the Poojasthaan(Temple). Recite the \"Hanuman Chalisa\" and \"Vastu Shanti\" jaap.Since the Main Door is not well positioned, Install the POWER GRID STICK above the Main Door Frame(at the inner side/inside the property).\no Option 1: Screw/fix 2 'white metal hooks' on the wall(above the main door frame)(keep about 1.5 feet distance between the 2 'hooks'). Hang/place the POWER GRID STICKbetween the 2 'hooks'.\no Option 2: Embed the POWER GRID STICK within the wall(above the main door frame). Create a horizontal hole in the wall(hole should be measuring 25 inches long x 1.5 inches deep). Place the POWER GRID STICK in it. Thereafter re-plaster the wall.\n\n• General attributes of South-West zone(Nairuti Kona):\nSouth-West Ruled by: Lord Nairut\nSouth-West Ruled by: Rahu Planet\nColor: Black, Blackish Brown, Violet\nMantra to be recited: 'Om Bhram Bhrim Bhroom Sah Rahvey Namah'.\nGemstone: Gomed(Zircon) Lead.\nElement: Earth(Prithvi Tatva).",
 ...
 func load_image(imageURl:String,meg:String){
        
        
        notification_View.hidden = false
        
        notification_lbl.text = meg
 ...
 func update(){
        ...
        let image = UIImage(named: "arrow")
         ...
         arrow.setImage(image, forState: .Normal)
            ...
            let image = UIImage(named: "arrrow")
